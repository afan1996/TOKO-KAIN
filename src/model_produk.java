...
public class model_produk extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(model_produk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
